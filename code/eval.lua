...
embedding_net_q=nn.Sequential()
				...
				:add(nn.Tanh())
--encoder: RNN body
--encoder_net_q=LSTM.lstm_conventional(embedding_size_q,lstm_size_q,dummy_output_size,nlstm_layers_q)
...
multimodal_net=nn.Sequential()
				...
				--:add(netdef.AxB(2*lstm_size_q*nlstm_layers_q,nhimage,common_embedding_size))
				:add(nn.Dropout(0.5))
...
saveJson(opt.out_path .. 'MultipleChoice_mscoco_lstm_results.json',mc_response);
>>>>>>> 32e08810023a405b9bf67f0100dedfcd7eba43e7
